...
function resume() {
  window.open(
    "https://drive.google.com/file/d/1meaEmF02WrCt762-fus1JhQpWWVIo_a9/view?usp=sharing"
  );
}
function NavBar() {
  return (
